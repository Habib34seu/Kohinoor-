...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
        <h1 class="h2">Quarterly Result</h1>
    </div>
...
<form action="{{route('qr-create')}}" method ="post" enctype="multipart/form-data">
 @csrf
    <div class="form-group row">
      <label for="inputEmail3" class="col-sm-2 col-form-label"> Quarterly Name</label>
      <div class="col-sm-6">
        <input type="text" class="form-control" name ="name" id="name" placeholder="Quarterly Name">
      </div>
    </div>
    <div class="form-group row">
                ...
                @foreach($data as $i )
                  <tr>
                      ...
                      <td style="width:350px;"><img class="bd-placeholder-img img-st" width="150px" 
                             height="150px" src="{{asset('uploades/qr/').'/'.$i->img}}"></td>
